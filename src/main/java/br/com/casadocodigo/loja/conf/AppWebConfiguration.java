...
@EnableWebMvc
@ComponentScan(basePackageClasses = {CarrinhoControler.class, HomeController.class, ProdutosController.class,CarrinhoCompras.class, ProdutoDAO.class, FileSaver.class })
